...
function MemberCard(props) {
  ...
  return (
    <>
      <div className="bg-[#005B96] my-10 p-5 flex flex-col  justify-center items-center border-[3px] border-gray-500 border-opacity-10 sm:border-gray-250 sm:border-[1px] sm:text-left  shadow-md shadow-gray-200  ">
        <div
        ...
        <h3 className="p-5 text-xl text-primary font-semibold sm:text-2xl sm:px-1 sm:text-center sm:justify-center ">{name}</h3>
