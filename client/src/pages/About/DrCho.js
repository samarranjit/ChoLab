  ...
  return (
    <div className='px-[5rem] py-5  flex sm:flex-col  sm:p-7  gap-[7rem] items-center justify-center'>
      <div className="flex gap-[2rem] mx-auto">
        ...
        <div className="left w-[40%] sm:flex sm:justify-center sm:h-full sm:w-[100%] sm:items-center sm:my-10">
        ...
        <div className="right w-[80%] sm:w-full">
            <p className='text-2xl text-tertiary sm:text-xl'>

            Meet the PI
            </p>
            <div className="flex border-b-[2.5px] border-b-[50%] mb-10 border-b-tertiary p-2 sm:text-xl sm:p-1 sm:pl-0 sm:mb-5">

            <h1 className='text-2xl font-semibold mt-10 sm:text-2xl sm:w-[100%] sm:mt-5'>Dr. Eunsang Cho</h1>
