...
function Publication() {
  ...
  return (
    <>
      <Navbar />
      {/* <div className="header flex flex-col justify-center items-center h-[70vh] bg-fixed bg-top  bg-contain bg-[url('https://plus.unsplash.com/premium_photo-1675369009502-4125a781576a?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')]">
        <section className='text-white font-semibold text-5xl '>
          Publications
        </section>
        <p className='my-5 text-2xl text-white'>Eunsang Cho publications and links to papers</p>
      </div> */}
